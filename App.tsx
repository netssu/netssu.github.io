    ...
    <div className="flex justify-center border-b-2 border-gray-700">
        ...
        {showMonsters && (
            <button 
                ...
                className={`px-6 py-2 font-serif text-lg transition-colors duration-200 ${currentPage === 'page4' ? 'text-brand-red-400 border-b-2 border-brand-red-400' : 'text-gray-400 hover:text-brand-parchment-light'}`}
            >
                Monstros
            </button>
        )}
